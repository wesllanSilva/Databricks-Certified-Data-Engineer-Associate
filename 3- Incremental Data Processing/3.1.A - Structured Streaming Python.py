...
# Ler a tabela com checkpoint
display(spark.table("books_streaming_tmp_vw"), checkpointLocation = "/Volumes/demo_prep_associate/demo_datasets/demo_checkpoints/Streaming/")
...
# criar df a partir da view
streaming_df = spark.readStream.table("books_streaming_tmp_vw")

from pyspark.sql import functions as F
agg_df = (streaming_df\
        .groupBy("author")\
        .agg(F.count("book_id").alias("total_books")))

# Exibir o df garantindo o checkpoint para o estado da agregação
display(agg_df,checkpointLocation = "/Volumes/demo_prep_associate/demo_datasets/demo_checkpoints/Streaming/query_agg/")
